...
// Custom Markdown Widget integrating the Builders
...
// ==========================================
final Color paperBg = const Color(0xFFE5DDF0); // Light Purple
...
class ProTestApp extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return MaterialApp(title: 'PLAIN TEST', debugShowCheckedModeBanner: false, theme: brutalistTheme, home: const MainNavigationScreen());
  }
}
